    ...
    <div className=" body-font font-style: italic h-10">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <a className="flex title-font font-medium items-center md:justify-start justify-center ">
          ...
          <span className="ml-3 text-xl text-gray-900">NailsArt</span>
        </a>
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start space-x-3 ">
          {/* <a
            className=""
            href="https://www.facebook.com/profile.php?id=100076907267919&mibextid=LQQJ4d"
          >
            <svg
              fill="currentColor"
              stroke-linecap="round"
          ...
          <a
            class="[&>svg]:h-5 [&>svg]:w-10"
            href="https://www.tiktok.com/@romigomez393?_t=8kxEoJZp6Pd&_r=1"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
